const translations = {
  es: {
    ...
    register_show: 'Crear cuenta',
    register_hide: 'Ocultar registro',
    ...
    register_exists: 'Ese usuario ya existe.',
    ...
    reportes_meta_title: 'Datos de Exportación',
    reportes_meta_help: 'Estos datos se usarán en el encabezado del Excel.',
    reportes_meta_carrera: 'Carrera',
    reportes_meta_especialidad: 'Especialidad',
    reportes_meta_cuatrimestre: 'Cuatrimestre (meses)',
    reportes_meta_turno: 'Turno',
    reportes_meta_fecha: 'Fecha de elaboración',
    reportes_meta_placeholder_cuatrimestre: 'ENERO-ABRIL 2026',
    reportes_priority: 'Orden de materias',
    reportes_meta_required: 'Completa los datos de exportación antes de continuar.',
  ...
  en: {
    ...
    register_show: 'Create account',
    register_hide: 'Hide registration',
    register_user: 'Username',
    register_email: 'Email',
    register_pass: 'Password',
    register_button: 'Register',
    register_success: 'Registration successful. You can sign in now.',
    register_exists: 'That username already exists.',
    ...
    reportes_meta_title: 'Export Details',
    reportes_meta_help: 'These values are used in the Excel header.',
    reportes_meta_carrera: 'Program',
    reportes_meta_especialidad: 'Specialty',
    reportes_meta_cuatrimestre: 'Term (months)',
    reportes_meta_turno: 'Shift',
    reportes_meta_fecha: 'Creation date',
    reportes_meta_placeholder_cuatrimestre: 'JAN-APR 2026',
    reportes_priority: 'Subject priority',
    reportes_meta_required: 'Complete the export details before continuing.',
